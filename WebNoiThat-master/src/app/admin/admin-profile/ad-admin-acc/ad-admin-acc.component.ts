...
@Component({
  selector: 'app-ad-admin-acc',
  templateUrl: './ad-admin-acc.component.html',
  styleUrls: ['./ad-admin-acc.component.css']
})
export class AdAdminAccComponent implements OnInit {
  ...
  onSubmitCreate(addForm1: FormGroup) {    
    ...
    this.employeeService.createNewAdmin(formData).subscribe(data => {
      console.log(data);
      Swal.fire(
        'Đã thêm!',
